...
export async function PUT(req: NextRequest, { params }: { params: { path: string[] } }) { return proxy('PUT', req, params.path); }
export async function PATCH(req: NextRequest, { params }: { params: { path: string[] } }) { return proxy('PATCH', req, params.path); }
export async function DELETE(req: NextRequest, { params }: { params: { path: string[] } }) { return proxy('DELETE', req, params.path); }
async function proxy(method: string, req: NextRequest, pathParts: string[]) {
  ...
  const resHeaders = new Headers(resp.headers); resHeaders.set('x-proxied-by','skinzai');
